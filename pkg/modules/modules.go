...
func (m *Module) SetOption(option string, value []string) (string, error) {
	...
	for k, v := range m.Options {
		if option == v.Name {
			// Take in a slice of string for arguments that contain spaces; https://github.com/testtoto1337/merzhin/issues/88
